  ...
  return (
    <div className="human-graph">
      <div className="graph-header">
        <div className="graph-human-title font-th" data-aos="fade-up">ค่าใช้จ่ายด้านการวิจัยและพัฒนาเฉลี่ยต่อกิจการในปี 2560</div>
        <div className="graph-desc align-center font-th" style={{ marginTop: 10 }} data-aos="fade-up">
          {' '}
      ...
      <div className="graph-human-graph" data-aos="fade-up">
        ...
        <div className="graph-human-graph-title-topic font-th" data-aos="fade-up">การค้าส่ง / ค้าปลีก</div>
        <div className="row">
          <div className="col-6">
        ...
        <div className="graph-human-graph-title-topic font-th" data-aos="fade-up">การบริการ</div>
        <div className="row">
          <div className="col-6">
            <div className="graph-human-graph-left" data-aos="fade-right">
              {' '}
        ...
        <div className="graph-human-graph-title-topic font-th" data-aos="fade-up">การผลิต</div>
        <div className="row">
          <div className="col-6">
            <div className="graph-human-graph-left" data-aos="fade-right">
              {' '}
        ...
        <div className="graph-human-graph-title-topic font-th" style={{ color: '#7a5699' }} data-aos="fade-up">
          รวมทั้งสิ้น
        </div>
        <div className="row">
          <div className="col-6">
            <div className="graph-human-graph-left graph-human-total-all font-th" data-aos="fade-right"> 92,131 </div>
          </div>
          <div className="col-6 spliter">
