...
const Organization = () => {
  return (
    <div className="org-page row">
      ...
      <div className="org-content-desc-bottom col-md-12" data-aos="fade-up">
